    ...
    <div class="header-wrapper">
        <table class="header-table">
            ...
            <tr>
                ...
                <td class="info-col">
                    <p><strong>Total de blocos:</strong> {{ $blocos->count() }}</p>
                </td>
            </tr>
        </table>
    </div>
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th style="width: 22%;">PRÉDIO</th>
                <th style="width: 20%;">CAMPUS</th>
                <th style="width: 10%;" class="text-center">ANDARES</th>
        ...
        <tbody>
            ...
            <tr>
                <td><strong>{{ $bloco->codigo ?? '-' }}</strong></td>
                <td><strong>{{ $bloco->nome }}</strong></td>
                <td>{{ $bloco->predio?->nome ?? '-' }}</td>
                <td>{{ $bloco->predio?->campus?->nome ?? '-' }}</td>
                <td class="text-center">{{ $bloco->andares_count ?? $bloco->andares->count() }}</td>
                <td>
                    <span class="badge badge-{{ strtolower($bloco->status ?? 'ativo') }}">
                        {{ $bloco->status ?? 'Ativo' }}
                    </span>
                </td>
            </tr>
